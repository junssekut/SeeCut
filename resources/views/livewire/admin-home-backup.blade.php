...
<div class="flex h-screen bg-gradient-to-br from-gray-50 to-gray-100">
    <aside class="w-64 bg-Charcoal text-Ecru flex flex-col p-4 shadow-xl">
        <div class="p-2 mb-4">
            <img src="{{ asset('assets/ld/logo-text.png') }}" alt="" srcset="">
        </div>
            ...
            <ul>
                ...
                <li class="mb-2">
                    <a href="{{ route('berlangganan') }}"
                        class="flex items-center font-Kuunari text-2xl p-3 hover:bg-Ecru hover:text-Charcoal rounded-lg font-semibold transition-all duration-300">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 mr-3" fill="none" viewBox="0 0 24 24"
                            stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <div class="mt-auto">
            <a href="#"
                class="flex items-center p-3 hover:bg-Ecru hover:text-Charcoal rounded-lg font-semibold transition-all duration-300">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 mr-3" fill="none" viewBox="0 0 24 24"
                    stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
    ...
    <main class="flex-1 p-8 overflow-y-auto bg-gradient-to-br from-gray-50 to-gray-100">
        <header class="flex justify-between items-center mb-10">
            <div>
                <h1 class="text-5xl font-extrabold text-gray-900 tracking-wider font-Kuunari mb-2">DASHBOARD ADMIN</h1>
                <p class="text-gray-600 text-lg">Selamat datang di dashboard admin SeeCut</p>
            </div>
            <div class="flex items-center space-x-4 bg-white px-6 py-3 rounded-xl shadow-sm">
                <div class="text-right">
                    <p class="font-semibold text-gray-900">Matthew Raditya</p>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-7 gap-8">
            <div class="lg:col-span-5 space-y-8">
                <section
                    ...
                    <div class="flex justify-between items-center mb-6">
                        <div>
                            ...
                            <p class="text-gray-600">Overview statistik sistem</p>
                        </div>
                        <button
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-3 gap-6">
                        <div
                            ...
                            <div class="flex items-center justify-between mb-4">
                                <p class="text-purple-600 text-sm font-semibold">Total Users</p>
                                <div
                        ...
                        <div
                            ...
                            <div class="flex items-center justify-between mb-4">
                                <p class="text-orange-600 text-sm font-semibold">Avg Revenue</p>
                                <div
                        ...
                        <div
                            ...
                            <div class="flex items-center justify-between mb-4">
                                <p class="text-teal-600 text-sm font-semibold">Growth Rate</p>
                                <div
                ...
                <!-- Revenue Growth Chart Section (Moved here for bigger size) -->
                <section
                    class="bg-white p-8 rounded-2xl shadow-sm border border-gray-100 hover:shadow-md transition-shadow duration-300">
                    <div class="flex justify-between items-center mb-6">
                        <div>
                        ...
                        <div class="flex items-center space-x-2">
                            ...
                            <span class="text-sm text-gray-600 font-medium">Growth:
            ...
            <div class="lg:col-span-2 space-y-6">
                <!-- Subscription Plans Section (Smaller) -->
                <section
                    ...
                    <!-- Subscription Chart (Smaller) -->
                    <div class="mb-4">
                        <div class="bg-gradient-to-br from-gray-50 to-gray-100 rounded-xl p-4" style="height: 200px;">
...
<script>
    ...
    function exportPackageData() {
        ...
        link.setAttribute("download", `package_distribution_${new Date().toISOString().split('T')[0]}.csv`);
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // Subscription Distribution Chart (Smaller)
        ...
        Chart.register({
            ...
            beforeDraw(chart) {
                if (chart.config.type === 'doughnut') {
                    ...
                    ctx.fillText('Total Users', width / 2, height / 2 + 10);
                    ctx.restore();
                }
            }
        });

        // Add hover animations for subscription cards
