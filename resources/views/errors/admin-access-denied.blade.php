    ...
    <div class="min-h-screen bg-Eerie-Black flex items-center justify-center px-4">
        <div class="max-w-md w-full bg-white rounded-lg shadow-xl p-8 text-center">
            ...
            <p class="text-gray-600 mb-6 font-Poppins">
                Maaf, Anda tidak memiliki izin untuk mengakses panel admin.
                Halaman ini khusus untuk administrator sistem SeeCut.
            </p>

            <!-- Additional Info -->
            <div class="bg-red-50 rounded-lg p-4 mb-6 border border-red-200">
                <p class="text-sm text-red-700 font-Poppins">
                    <strong>Peringatan:</strong> Akses administrator dibatasi untuk personel yang berwenang.
                    Jika Anda memerlukan akses admin, silakan hubungi tim teknis SeeCut.
                </p>
            </div>
            ...
            <div class="space-y-3">
                ...
                <button onclick="goBack()"
                    class="w-full bg-blue-600 text-white py-3 px-6 rounded-lg font-Kuunari text-lg hover:bg-blue-700 transition-all duration-300 focus:outline-none focus:ring-4 focus:ring-blue-600/30">
            ...
            <div class="mt-8 pt-6 border-t border-gray-200">
                <p class="text-xs text-gray-500 font-Poppins">
                    Butuh bantuan? Hubungi tim teknis SeeCut untuk informasi lebih lanjut tentang akses administrator.
                </p>
            </div>
        </div>
    </div>
